...

{
    ...
    foreach ($resultSet as $pakket) {
        $pakketObj = new Pakket($pakket["reisNummer"], $resultSet["reisOmschrijving"], $resultSet["reisType"], $resultSet["stad"],$resultSet["land"], 0,  $resultSet["hotelNaam"], $resultSet["prijs"]);
